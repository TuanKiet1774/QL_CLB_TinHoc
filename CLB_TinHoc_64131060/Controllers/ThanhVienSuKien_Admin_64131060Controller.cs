...
{
    public class ThanhVienSuKien_Admin_64131060Controller : Controller
    {
        private CLBTinHoc_64131060Entities1 db = new CLBTinHoc_64131060Entities1();

        // GET: ThanhVienSuKien_Admin_64131060
        public ActionResult ThanhVienSuKien_Admin_64131060()
        {
            var thanhVienSuKiens = db.ThanhVienSuKiens.Include(t => t.SuKien).Include(t => t.ThanhVien);
            return View(thanhVienSuKiens.ToList());
        }

        // GET: ThanhVienSuKien_Admin_64131060/Details/5
        ...
        // GET: ThanhVienSuKien_Admin_64131060/Create
        ...
        public ActionResult Create([Bind(Include = "MaSuKien,MaThanhVien,NgayDangKy")] ThanhVienSuKien thanhVienSuKien)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                return RedirectToAction("ThanhVienSuKien_Admin_64131060");
            }
        ...
        // GET: ThanhVienSuKien_Admin_64131060/Edit/5
        ...
        // POST: ThanhVienSuKien_Admin_64131060/Edit/5
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: ThanhVienSuKien_Admin_64131060/Delete/5
