...
namespace CLB_TinHoc_64131060.Controllers
{
    public class DiemDanh_Member_64131060Controller : Controller
    {
        ...
        // POST: DiemDanh_Member_64131060/Create
        ...
        public ActionResult Create([Bind(Include = "MaDiemDanh,MaNhom,MaThanhVien,NgayDiemDanh,TrangThai,GhiChu")] DiemDanh diemDanh)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                return RedirectToAction("Alert_Member_64131060");
            }
        ...
        public ActionResult Alert_Member_64131060()
        {
            return View();
        }

        // GET: DiemDanh_Member_64131060/Edit/5
        ...
        // POST: DiemDanh_Member_64131060/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: DiemDanh_Member_64131060/Delete/5
        ...
        // POST: DiemDanh_Member_64131060/Delete/5
