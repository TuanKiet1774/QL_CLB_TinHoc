...
{
    public class DiemDanh_Assitant_64131060Controller : Controller
    {
        private CLBTinHoc_64131060Entities1 db = new CLBTinHoc_64131060Entities1();

        // GET: DiemDanh_Assitant_64131060
        public ActionResult DiemDanh_Assitant_64131060()
        {
            var diemDanhs = db.DiemDanhs.Include(d => d.NhomHocTap).Include(d => d.ThanhVien);
            return View(diemDanhs.ToList());
        }

        // GET: DiemDanh_Assitant_64131060/Details/5
        ...
        // GET: DiemDanh_Assitant_64131060/Create
        ...
        // POST: DiemDanh_Assitant_64131060/Create
        ...
        // GET: DiemDanh_Assitant_64131060/Edit/5
        ...
        // POST: DiemDanh_Assitant_64131060/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: DiemDanh_Assitant_64131060/Delete/5
        ...
        // POST: DiemDanh_Assitant_64131060/Delete/5
