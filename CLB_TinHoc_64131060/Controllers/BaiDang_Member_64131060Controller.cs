...
{
    public class BaiDang_Member_64131060Controller : Controller
    {
        private CLBTinHoc_64131060Entities1 db = new CLBTinHoc_64131060Entities1();

        // GET: BaiDang_Member_64131060
        public ActionResult BaiDang_Member_64131060()
        {
            var baiDangs = db.BaiDangs.Include(b => b.ThanhVien);
            return View(baiDangs.ToList());
        }

        // GET: BaiDang_Member_64131060/Details/5
        ...
        public ActionResult Create([Bind(Include = "MaBaiDang,TieuDe,Anh,NoiDung,TacGia,NgayTao")] BaiDang baiDang, HttpPostedFileBase Anh)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("BaiDang_Member_64131060");
            }
        ...
        // GET: BaiDang_Member_64131060/Edit/5
        ...
        // POST: BaiDang_Member_64131060/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: BaiDang_Member_64131060/Delete/5
        ...
        // POST: BaiDang_Member_64131060/Delete/5
