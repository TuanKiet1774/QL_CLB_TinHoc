...
{
    public class SuKien_64131060Controller : Controller
    {
        private CLBTinHoc_64131060Entities1 db = new CLBTinHoc_64131060Entities1();

        // GET: SuKien_64131060
        public ActionResult SuKien_64131060()
        {
            var suKiens = db.SuKiens.Include(s => s.ThanhVien);
            return View(suKiens.ToList());
        }

        public ActionResult TimKiemSuKien_64131060(string maSuKien = "", string tenSuKien = "")
        {
