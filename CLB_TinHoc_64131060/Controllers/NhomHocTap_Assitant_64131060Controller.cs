...
{
    public class NhomHocTap_Assitant_64131060Controller : Controller
    {
        private CLBTinHoc_64131060Entities1 db = new CLBTinHoc_64131060Entities1();

        // GET: NhomHocTap_Assitant_64131060
        public ActionResult NhomHocTap_Assitant_64131060()
        {
            var nhomHocTaps = db.NhomHocTaps.Include(n => n.ThanhVien);
            return View(nhomHocTaps.ToList());
        }

        // GET: NhomHocTap_Assitant_64131060/Details/5
        ...
        // GET: NhomHocTap_Assitant_64131060/Create
        ...
        // POST: NhomHocTap_Assitant_64131060/Create
        ...
        public ActionResult Create([Bind(Include = "MaNhom,TenNhom,TroGiang,NgayTao,MoTa")] NhomHocTap nhomHocTap)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                return RedirectToAction("NhomHocTap_Assitant_64131060");
            }
        ...
        // GET: NhomHocTap_Assitant_64131060/Edit/5
        ...
        // POST: NhomHocTap_Assitant_64131060/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: NhomHocTap_Assitant_64131060/Delete/5
        ...
        // POST: NhomHocTap_Assitant_64131060/Delete/5
