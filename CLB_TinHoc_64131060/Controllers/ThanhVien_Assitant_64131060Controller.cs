...
{
    public class ThanhVien_Assitant_64131060Controller : Controller
    {
        private CLBTinHoc_64131060Entities1 db = new CLBTinHoc_64131060Entities1();

        // GET: ThanhVien_Assitant_64131060
        public ActionResult ThanhVien_Assitant_64131060()
        {
            var thanhViens = db.ThanhViens.Include(t => t.VaiTro);
            return View(thanhViens.ToList());
        }

        public ActionResult TimKiemTV_Assitant_64131060(string mathanhvien = "", string hoten = "")
        {
        ...
        // GET: ThanhVien_Assitant_64131060/Details/5
        ...
        // GET: ThanhVien_Assitant_64131060/Create
        ...
        // POST: ThanhVien_Assitant_64131060/Create
        ...
        public ActionResult Create([Bind(Include = "MaThanhVien,HoTen,Email,MatKhau,MaVaiTro,NgayTao")] ThanhVien thanhVien)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                return RedirectToAction("TimKiemTV_Assitant_64131060");
            }
        ...
        // GET: ThanhVien_Assitant_64131060/Edit/5
        public ActionResult Edit_Assistant_64131060(string id)
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            ...
            {
                thanhVien.MaVaiTro = "TVTG"; // Mặc định là "Thành viên bình thường"
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit_Assistant_64131060([Bind(Include = "MaThanhVien,HoTen,Email,MatKhau,MaVaiTro,NgayTao")] ThanhVien thanhVien)
        {
            if (ModelState.IsValid)
            {
                db.Entry(thanhVien).State = EntityState.Modified;
                db.SaveChanges();
                return RedirectToAction("Assitant_Page_64131060");
            }
            ViewBag.MaVaiTro = new SelectList(db.VaiTroes, "MaVaiTro", "TenVaiTro", thanhVien.MaVaiTro);
            return View(thanhVien);
        }

        // GET: ThanhVien_Assitant_64131060/Delete/5
        ...
        // POST: ThanhVien_Assitant_64131060/Delete/5
        ...
        public ActionResult Assitant_Page_64131060()
        {
