...
{
    public class SuKien_Assitant_64131060Controller : Controller
    {
        private CLBTinHoc_64131060Entities1 db = new CLBTinHoc_64131060Entities1();

        // GET: SuKien_Assitant_64131060
        public ActionResult SuKien_Assitant_64131060()
        {
            var suKiens = db.SuKiens.Include(s => s.ThanhVien);
            return View(suKiens.ToList());
        }

        public ActionResult TimKiemSuKien_Assitant_64131060(string maSuKien = "", string tenSuKien = "")
        {
        ...
        // GET: SuKien_Assitant_64131060/Details/5
        public ActionResult Details(string id)
        {
            ...
            SuKien suKien = db.SuKiens
                .Include(s => s.ThanhVienSuKiens.Select(tvs => tvs.ThanhVien))  // Đảm bảo tải thành viên liên quan
                .FirstOrDefault(s => s.MaSuKien == id);
        ...
        // GET: SuKien_Assitant_64131060/Create
        ...
        // POST: SuKien_Assitant_64131060/Create
        ...
        public ActionResult Create([Bind(Include = "MaSuKien,TenSuKien,MoTa,NgayBatDau,NgayKetThuc,NguoiToChuc")] SuKien suKien)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                return RedirectToAction("TimKiemSuKien_Assitant_64131060");
            }
        ...
        // GET: SuKien_Assitant_64131060/Edit/5
        ...
        // POST: SuKien_Assitant_64131060/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: SuKien_Assitant_64131060/Delete/5
        ...
        // POST: SuKien_Assitant_64131060/Delete/5
